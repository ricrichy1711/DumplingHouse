            ...
            <div className="relative z-10 min-h-screen">
                ...
                >
                    <div className="relative max-w-7xl mx-auto z-10">
                        {/* Main Flex Container */}
                        <div className="flex flex-col xl:flex-row xl:items-end gap-4 lg:gap-8 w-full overflow-hidden">

                            {/* LEFT COLUMN: Header + Image */}
                            <div className="w-full xl:w-[260px] flex flex-col gap-4 lg:gap-8 shrink-0">
                                {/* 1. Headers */}
                                ...
                                {config.menuFeaturedImage && (
                                    <div className="w-full aspect-square md:aspect-[4/3] xl:aspect-auto xl:h-[380px] rounded-3xl overflow-hidden border border-white/5 shadow-2xl shrink-0 xl:flex-1">
                                        <img
                            ...
                            <div className="flex-1 flex flex-col min-w-0 gap-4 xl:pt-2">
                                {/* 3. Categories */}
                                <div className="flex flex-wrap gap-2 overflow-x-auto pb-2 scrollbar-hide">
                                    {categories.map(cat => (
                                        <button
                                            ...
                                            className={`px-4 py-1.5 rounded-full text-[10px] font-bold transition-all border whitespace-nowrap ${activeCategory === cat
