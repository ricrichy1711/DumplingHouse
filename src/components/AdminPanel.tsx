        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <button
              ...
              className="p-2 text-white hover:text-red-500 sm:hidden"
            >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="bg-red-500/10 text-red-500 border border-red-500/20 px-4 py-2 rounded-lg font-black uppercase text-xs tracking-widest hidden sm:block">
              Panel de Control
            </div>
          </div>
        </div>
